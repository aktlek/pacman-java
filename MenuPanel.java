...
public class MenuPanel extends JPanel {
	...
	private MenuButton btnNewButton_2;
	private MenuButton btnNewButton_3;
	...
	private void createContents() {
		...
		}
		{
			...
			{
				btnNewButton = new MenuButton("START GAME");
				...
				btnNewButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						click.play();
						MainFrame.menus.show(MainFrame.contentPane, "game");
					}
				});
				panel.add(btnNewButton);
			}
			{
				btnNewButton_4 = new MenuButton("HIGH SCORES");
				...
				btnNewButton_4.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						click.play();
						MainFrame.menus.show(MainFrame.contentPane, "high");
					}
				});
				panel.add(btnNewButton_4);
			}
			{
				btnNewButton_1 = new MenuButton("HELP");
				...
				btnNewButton_1.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						click.play();
						MainFrame.menus.show(MainFrame.contentPane, "help");
					}
				});
				panel.add(btnNewButton_1);
			}
			{
				btnNewButton_2 = new MenuButton("ABOUT");
				...
				btnNewButton_2.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						click.play();
						MainFrame.menus.show(MainFrame.contentPane, "about");
					}
				});
				panel.add(btnNewButton_2);
			}
			{
				btnNewButton_3 = new MenuButton("EXIT");
